...
@Autonomous(name = "Handoff Test 1")
public class HandoffTest1 extends OpMode {
    ...
    private HandoffTest1.PathPosition pathPosition;
    ...
    public void init() {
        ...
        pathPosition = HandoffTest1.PathPosition.START;
...
//                    Actions.runBlocking(jazzHands);
//                    Actions.runBlocking(newHandoffAction());
                      Actions.runBlocking(new SleepAction(1));
                    Actions.runBlocking(horizontalArm.wristTo(Positions.HorizontalWristPosition.DOWN));
                    Actions.runBlocking(new SleepAction(1));
                    Actions.runBlocking(horizontalArm.wristTo(Positions.HorizontalWristPosition.UP));
                    Actions.runBlocking(new SleepAction(0.5));
                    Actions.runBlocking(verticalArm.closeClaw());
                    Actions.runBlocking(new SleepAction(0.5));
                    Actions.runBlocking(horizontalArm.openClaw());
                })
...
//        ));
    ...
    public Action newHandoffAction() {
        return new SequentialAction(
                new SleepAction(1),
                horizontalArm.wristTo(Positions.HorizontalWristPosition.DOWN),
                new SleepAction(1),
                horizontalArm.wristTo(Positions.HorizontalWristPosition.UP),
                new SleepAction(0.5),
