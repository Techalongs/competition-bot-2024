...
@Autonomous(name = "Asynch Sample")
public class AsynchSample extends OpMode {
    ...
    private Action dropSample, readyForPickup, pickup, handoff, park;
    ...
    private void initActions() {
        dropSample =
                new SequentialAction(
                        ...
                        verticalClaw.asynchHingeTo(Positions.VerticalHingePosition.UP),
                        new SleepAction(0.5),
                        verticalClaw.open(),
                        new SleepAction(0.5),
                        verticalClaw.close(),
    ...
    private void buildPaths() {
        ...
        paths[3] = follower.pathBuilder()
                .addPath(
                        ...
                        new BezierLine(
                                new Point(15.000, 126.000, Point.CARTESIAN),
                                new Point(33.000, 127.000, Point.CARTESIAN)
                        )
                )
                .setLinearHeadingInterpolation(Math.toRadians(135), Math.toRadians(180))
                .build();
